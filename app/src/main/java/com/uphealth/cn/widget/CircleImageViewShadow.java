...
public class CircleImageViewShadow extends ImageView {
	
private static final ScaleType SCALE_TYPE = ScaleType.CENTER_CROP;
	
    private static final Bitmap.Config BITMAP_CONFIG = Bitmap.Config.ARGB_8888;
    private static final int COLORDRAWABLE_DIMENSION = 5;
    ...
    public CircleImageViewShadow(Context context) {
        super(context);
 
        init();
    }
 
    public CircleImageViewShadow(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
 
    public CircleImageViewShadow(Context context, AttributeSet attrs, int defStyle) {
