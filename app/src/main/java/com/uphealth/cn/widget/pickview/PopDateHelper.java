...
public class PopDateHelper {
    ...
    private void initData() {
        listDate = DatePackerUtil.getProvinceListTwo(context , "province.txt");
        listTime = DatePackerUtil.getCityAllListTwo();
    }
    ...
    private void initView() {
        ...
        loopView1.setListener(new LoopListener() {
            ...
            public void onItemSelect(int item) {
                ...
                listTime.clear();
                listTime = DatePackerUtil.getCitySingleListTwo(context ,GlobalData.provinceLists.get(item).getProID()) ;
                loopView2.setList(listTime);
                loopView2.setCurrentItem(0);
            }
        });
