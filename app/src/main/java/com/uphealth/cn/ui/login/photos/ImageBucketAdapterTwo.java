...
public class ImageBucketAdapterTwo extends BaseAdapter {
	...
	public ImageBucketAdapterTwo(Activity act, List<ImageBucket> list) {
		this.act = act;
		dataList = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			holder = new Holder();
			arg1 = View.inflate(act, R.layout.item_image_bucket_two, null);
