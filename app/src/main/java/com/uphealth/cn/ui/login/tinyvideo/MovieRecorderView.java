...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
	...
	public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
		...
		mHeight = a.getInteger(R.styleable.MovieRecorderView_height_1, 240);// 默认240

		isOpenCamera = a.getBoolean(
				R.styleable.MovieRecorderView_is_open_camera, true);// 默认打开
		mRecordMaxTime = a.getInteger(
				R.styleable.MovieRecorderView_record_max_time, 7);// 默认为10
...
//	    mediaRecorder.setMaxDuration(Constant.MAXVEDIOTIME * 60000);
		mMediaRecorder.setOutputFile(mVecordFile.getAbsolutePath());
		mMediaRecorder.setMaxFileSize(6*1024*1024);   // 设置视频最大6M
		mMediaRecorder.setMaxDuration(6*1000);
