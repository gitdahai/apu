package com.uphealth.cn.support.base.helper.photo.adapter;
...
import com.uphealth.cn.support.base.helper.photo.BitmapCacheActivity;
import com.uphealth.cn.support.base.helper.photo.BitmapCacheActivity.ImageCallback;
...
public class AlbumGridViewAdapter extends BaseAdapter {
	...
	BitmapCacheActivity mCache;
	private IOnItemCameraClickListener mItemCameraClickListener;

	public void setmItemCameraClickListener(
			IOnItemCameraClickListener itemCameraClickListener) {
		this.mItemCameraClickListener = itemCameraClickListener;
	}

	public AlbumGridViewAdapter(Context c, ArrayList<ImageItem> dataList,
			ArrayList<ImageItem> selectedDataList) {
		mContext = c;
		mCache = new BitmapCacheActivity();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.toggleView = convertView.findViewById(R.id.toggle);
		...
		if (position == 0) {
			...
			viewHolder.toggleView.setVisibility(View.GONE);
			viewHolder.imageView2.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View arg0) {
					mItemCameraClickListener.onItemCameraClick();
				}
			});
		} else {
			...
			if (path.contains("camera_default")) {
				...
				mCache.displayBmp(viewHolder.imageView, item.thumbnailPath,
	...
	public interface IOnItemCameraClickListener {
